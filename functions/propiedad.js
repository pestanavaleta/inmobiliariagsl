export async function onRequest(context) {
  ...
  const SHEET_URL = "https://docs.google.com/spreadsheets/d/1dRMLVmMsA5rBnQbWkpimSwZRyWhTiNZqzSR0TE-4QvE/export?format=csv";
  const URL_CONFIG = "https://docs.google.com/spreadsheets/d/1dRMLVmMsA5rBnQbWkpimSwZRyWhTiNZqzSR0TE-4QvE/export?format=csv&gid=70224827";
	...
	<footer class="footer relleno-1">
        <div class="contenedor">
            <article class="info">
                ...
                <p class="copy"><a href="https://www.youtube.com/artefox" target="_blank" style="color:var(--color-maestro)">Creado por ArteFox.</a> © ${anioActual} ${config.nombre}</p>
            </article>
