export async function onRequest(context) {
    const URL_PROPIEDADES = "https://docs.google.com/spreadsheets/d/1dRMLVmMsA5rBnQbWkpimSwZRyWhTiNZqzSR0TE-4QvE/export?format=csv";
    ...
    <footer class="footer relleno-1">
        <div class="contenedor">
            <article class="info">
                ...
                <p><a href="https://www.youtube.com/artefox" target="_blank" style="color:var(--color-maestro)">Creado por ArteFox.</a> © 2026 ${c.nombre}</p>          
				    <ul class="redes">
